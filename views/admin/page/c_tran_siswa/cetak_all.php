            ...
            <div class="col-md-12">
                <div class="">
                    <div class="text-center">
                      <h2><b>Yayasan Pendidikan Islam Ashabulyamin Pabuaran - Cianjur</b></h2>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-left">
                                <table>
                                  <!-- <tr>
                                    <td width="100px">Tanggal</td><td>:</td><td>2019-08-01</td>
                                  </tr> -->
                                  <tr>
                        ...
                        <div class="col-md-12">
                            <div class="pull-right m-t-30 text-right">
                                ...
                                <!-- <p>vat (10%) : $138 </p> -->
                                <hr>
                                <h3><b>Jumlah Bayar :</b> Rp. <?=number_format($total_tunggakan);?></h3>
